...
def prepare_inputs(payload: dict) -> dict:
    ...
    trimmed = trim_messages(
      raw_history, 
      token_counter=len, #conta a qtde de mensagens,
      max_tokens=2, #limite de mensagens a serem consideradas
      strategy="last",
      start_on="human",
      include_system=True,
      allow_partial=False, #pega mensagem por mensagem
    )
...
# exclui o resp1 pq estou trabalhando com max_tokens=2, ou seja, só as 2 últimas mensagens são consideradas no histórico.
