...
# Existe o CharacterTextSplitter e o RecursiveCharacterTextSplitter

# O RecursiveCharacterTextSplitter é mais inteligente e tenta não cortar palavras no meio, por exemplo. 
# Ele tem uma série de regras para tentar cortar o texto da melhor forma possível, 
# como por exemplo, tentar cortar em pontos finais ou vírgulas, para manter a coerência do texto.
 
# O CharacterTextSplitter é mais simples e corta o texto exatamente no número de caracteres definido, 
# sem se preocupar com a estrutura do texto.

splitter = RecursiveCharacterTextSplitter(
    chunk_size=250, chunk_overlap=70, 
)

parts = splitter.create_documents([long_text]) #gera um document
...
print(result["output_text"]) #pega somente o output_text do resultado, que é o resumo gerado pelo modelo.
